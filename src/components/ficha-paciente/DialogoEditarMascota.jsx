  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const dataToSubmit = {
        ...
        fecha_seceso: formData.estado === "Fallecido" ? new Date().toISOString().split('T')[0] : null
      };
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <select
                    ...
                    value={formData.estado || 'Vivo'}
                    onChange={(e) => handleInputChange('estado', e.target.value)}
                    className="mt-1 w-full h-12 px-3 border-2 rounded-full focus:ring-purple-500 focus:border-transparent border-purple-400"
                  >
